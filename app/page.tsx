...
const Services = () => {
  const galleryProjects = [
    { id: "1a", name: "Hotel Surya Tretes", year: "2014" },
    { id: "2a", name: "Hotel The Zuri Palembang", year: "2017" },
    { id: "3a", name: "Yello Hotel Jambi", year: "2019" },
    { id: "4a", name: "Transmart Cilegon", year: "2020" },
    { id: "5a", name: "PT DCI JK-5 Cibitung", year: "2021" },
    { id: "6a", name: "Grand Zuri Lubuk Linggau", year: "2022" },
    { id: "7a", name: "3R Hotel Manado", year: "2023" },
    { id: "8a", name: "Bali Beach Hotel", year: "2024" },
    { id: "9a", name: "Dakota Data Center Batam", year: "2024" },
    { id: "10a", name: "Equinix Data Center", year: "2024" },
    { id: "11a", name: "Transmart Jambi", year: "2018" },
    { id: "13a", name: "Transmart Pekanbaru", year: "2017" },
    { id: "14a", name: "Transmart Pangkalpinang", year: "2020" },
  ];

  const allProjects = [
    { name: "Hotel Surya Tretes", year: "2014" },
    { name: "Hotel The Zuri Palembang", year: "2017" },
    { name: "Yello Hotel Jambi", year: "2019" },
    { name: "Transmart Cilegon", year: "2020" },
    { name: "PT DCI JK-5 Cibitung", year: "2021" },
    { name: "Grand Zuri Lubuk Linggau", year: "2022" },
    { name: "3R Hotel Manado", year: "2023" },
    { name: "Bali Beach Hotel", year: "2024" },
    { name: "Dakota Data Center Batam", year: "2024" },
    { name: "Equinix Data Center", year: "2024" },
    { name: "Transmart Jambi", year: "2018" },
    { name: "Transmart Pekanbaru", year: "2017" },
    { name: "Transmart Pangkalpinang", year: "2020" },
  ];
